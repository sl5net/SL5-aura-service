...
```bash
            صدى "vosk-model-small-de-0.15" > التكوين/model_name.txt
```
...
```bash
                                              ...
                                              سودو شمود 600 /swapfile
                                                    سودو mkswap /swapfile
                                              سودو مبادلة /swapfile
 صدى \'/swapfile لا شيء مبادلة sw 0 0' | Sudo Tee -a /etc/fstab
```
