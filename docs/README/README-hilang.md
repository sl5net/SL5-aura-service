...
Xस्पेसब्रेकX
**ऑरा-कोर/** 🐧 🍏 🪟  
├─ `aura_engine.py` (मुख्य पायथन सेवा ऑर्केस्ट्रेटिंग ऑरा) 🐧 🍏 🪟  
...
│├ 2. **इंटेलिजेंट प्री-करेक्शन** ('फ़ज़ीमैप प्री' - [The Primary Command Layer](../CreatingNewPluginModules-hilang.md)) 🐧 🍏 🪟  
...
││ * **डायनेमिक स्क्रिप्ट निष्पादन:** नियम एपीआई कॉल, फ़ाइल I/O जैसी उन्नत क्रियाएं करने या गतिशील प्रतिक्रियाएं उत्पन्न करने के लिए कस्टम पायथन स्क्रिप्ट ([on_match_exec](../advanced-scripting-hilang.md)) को ट्रिगर कर सकते हैं।  
