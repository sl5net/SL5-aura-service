> ℹ️ *This is a machine-translated document. In case of discrepancies, refer to the [original document](../AutoFixModule.md).*
...
> This module is functional but not exhaustively tested. The following cases may not work correctly:
