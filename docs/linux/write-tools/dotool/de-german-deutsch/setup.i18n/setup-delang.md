## Konfiguration der Texteingabemethode

### Voraussetzungen für `dotool` (schneller als xdotool)

1. Installieren: `pamac build dotool` oder `yay -S dotool`
2. Benutzer zur Eingabegruppe hinzufügen: `sudo gpasswd -a $USER input`
...
- Das Auslesen der Einstellungen unterdrückt bewusst alle Print-Ausgaben aus `settings.py` während des Imports – das ist gewollt
