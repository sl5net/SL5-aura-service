> ℹ️ *This is a machine-translated document. In case of discrepancies, refer to the [original document](../dotool_setup_version_1.md).*

# dotool – Installation & Configuration (Manjaro / Arch based)

## What is dotool?

`dotool` is a quick tool for simulating keyboard input in Linux.
...
### 5 New login (important!)

Without new login, group membership does not apply.
