...
Um die Interaktion mit der STT-CLI (Speech-to-Text) zu vereinfachen, können Sie Ihrer „~/.bashrc“ eine Verknüpfungsfunktion hinzufügen. Dadurch können Sie einfach „Ihre Frage“ in das Terminal eingeben.
...
> **Hinweis:** Wenn Sie Bash als Login-Shell verwenden (z. B. über SSH), fügen Sie denselben Block auch zu „~/.bash_profile“ hinzu oder beziehen Sie „~/.bashrc“ daraus:
> „Bash
> [ -f ~/.bashrc ] && Quelle ~/.bashrc
> ```
