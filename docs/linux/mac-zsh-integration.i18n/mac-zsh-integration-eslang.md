...
- **Ruta de Python**: asegúrese de que su entorno virtual esté configurado en `$SL5NET_AURA_PROJECT_ROOT/.venv`. Si administra Python con `pyenv` o `conda`, ajuste `PY_EXEC` en consecuencia.
