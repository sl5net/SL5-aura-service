...
सेवा का प्राथमिक कार्य मैच के बारे में जानकारी प्राप्त करना है:

__CODE_ब्लॉक_0__

और फिर, एक क्रिया निष्पादित करें, और एक अंतिम स्ट्रिंग लौटाएँ जिसका उपयोग नए पाठ के रूप में किया जाएगा।
...
यह सभी निष्पादन योग्य स्क्रिप्ट के लिए मानक प्रवेश बिंदु है। नियम मेल खाने पर सिस्टम स्वचालित रूप से इस फ़ंक्शन को कॉल करेगा।
...
* ``text_after_replacement'` (str): नियम की मूल प्रतिस्थापन स्ट्रिंग को *बाद* में लागू किया गया था, लेकिन *पहले* आपकी स्क्रिप्ट को कॉल किया गया था। (यदि प्रतिस्थापन `` है, तो यह `original_text` के समान होगा)।
