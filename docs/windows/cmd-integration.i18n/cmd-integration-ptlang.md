...
> **Observação:** CMD (cmd.exe) é o shell herdado do Windows e tem limitações significativas em comparação aos shells PowerShell ou Unix. Para uma experiência mais rica, considere usar o [PowerShell Integration](.././powershell-integration.i18n/powershell-integration-ptlang.md) ou o [WSL Integration](.././wsl-integration.i18n/wsl-integration-ptlang.md).
