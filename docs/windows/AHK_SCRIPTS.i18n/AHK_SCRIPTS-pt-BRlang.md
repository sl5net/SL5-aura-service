...
Ao documentar o requisito **"Zombie Map"** e **"Task Scheduler/Admin"**, você explica a outros desenvolvedores (e a você mesmo no futuro) por que o código é mais complexo do que um simples script Linux. Ele transforma "soluções alternativas estranhas" em "soluções projetadas para as limitações do Windows".
