...
*Dica: depois de definir seus padrões regex, execute `python3 tools/map_tagger.py` para gerar automaticamente exemplos pesquisáveis para as ferramentas CLI. Consulte [Map Maintenance Tools](../../Developer_Guide/Map_Maintenance_Tools-ptlang.md) para obter detalhes.*