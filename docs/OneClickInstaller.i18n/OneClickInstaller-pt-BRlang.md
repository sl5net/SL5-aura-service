...
Economiza cerca de 30 segundos de manipulação manual de arquivos e inicia imediatamente no seu terminal:
...
Baixe o arquivo único do instalador correspondente ao seu sistema operacional a partir do [Último Lançamento no GitHub]:
...
- **Aprenda com Koans:** Explore conceitos passo a passo em [Getting Started](../GettingStarted.i18n/GettingStarted-pt-BRlang.md).
