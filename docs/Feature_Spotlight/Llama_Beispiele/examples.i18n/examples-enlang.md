> ℹ️ *This is a machine-translated document. In case of discrepancies, refer to the [original document](../examples.md).*
...
*   **LLM does:** *"Development, progress, innovation, further education, improvement."*
