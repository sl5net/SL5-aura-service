...
بدلاً من استخدام حالة داخلية، تقوم هذه الطريقة بتحرير خريطة القاعدة على نظام الملفات مباشرةً. يعمل البرنامج النصي `toggle_translation_mode.py` كمدير التكوين.
