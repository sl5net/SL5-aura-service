> ℹ️ *This is a machine-translated document. In case of discrepancies, refer to the [original document](../ImplementingToggleableLiveTranslationMode.md).*
...
```
When you say turn translation on, the `toggle_translation_mode.py` script is executed.
