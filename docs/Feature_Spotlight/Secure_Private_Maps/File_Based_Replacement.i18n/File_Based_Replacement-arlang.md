...
| `FILE4REPLACEMENT_ALLOW_PATH_TRAVERSAL` | `بول` | `خطأ` | إذا كانت `صحيح`، فإنها تسمح بحل الملفات خارج الدليل الخاص بالمكون الإضافي (على سبيل المثال، المسارات المطلقة، أو `../` التسلسلات). انظر قسم الأمان أدناه. |
