> ℹ️ *This is a machine-translated document. In case of discrepancies, refer to the [original document](../execute_only.md).*

# Rule Attributes: `execute_only` (Experimental, 7.7.'26 Tue)
