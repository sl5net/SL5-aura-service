> ℹ️ *This is a machine-translated document. In case of discrepancies, refer to the [original document](../explain_was_ist_ein_Haus_search.md).*

#explaining the exact behavior of your system's workflow:
...
Rule 1: Labeling/Transformation
...
Rule 2: General Action/Execution
