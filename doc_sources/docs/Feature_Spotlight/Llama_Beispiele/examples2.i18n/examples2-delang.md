...
* **Du sagst:** *"Aura formuliere das höflich: Ich habe keine Zeit für das Meeting, verschieben."*
...
* **Hinweis:** RegEx kann keine Grammatik. Das LLM schon.

### 2. Der „Linux-Spickzettel“
Statt zu googeln oder „Manpages“ zu lesen, fragst du einfach. Das Modell ist auf Code trainiert.
...
2. **Llama** für alles, was flexibel sein muss (Texte schreiben, Fragen beantworten). **(Intelligent und anpassungsfähig)**
