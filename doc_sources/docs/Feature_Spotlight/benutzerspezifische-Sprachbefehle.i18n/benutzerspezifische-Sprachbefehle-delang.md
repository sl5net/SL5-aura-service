...
```python
aus scripts.py.func.determine_current_user import discover_current_user

# 1. Wer bin ich?
aktueller_Benutzer, _ = bestimme_aktuellen_Benutzer()

wenn aktueller_Benutzer in ['misterx']:
MY_USER_RULES = [
