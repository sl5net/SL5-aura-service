...
> **Shell padrão desde o macOS Catalina (10.15).** Se você estiver no macOS Mojave ou anterior, consulte o guia [macOS Bash Integration](.././mac-bash-integration.i18n/mac-bash-integration-pt-BRlang.md).
