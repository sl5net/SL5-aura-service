...
> **Shell padrão antes do macOS Catalina (10.15).** Desde o Catalina, o macOS vem com Zsh como shell padrão. Se você estiver em um Mac moderno e não tiver alterado seu shell, consulte o guia [macOS Zsh Integration](.././mac-zsh-integration.i18n/mac-zsh-integration-pt-BRlang.md).
>
...
- **Caminho Python**: Certifique-se de que seu ambiente virtual esteja configurado em `$SL5NET_AURA_PROJECT_ROOT/.venv`. Se você gerencia Python com `pyenv` ou `conda`, ajuste `PY_EXEC` de acordo.
