...
- **Python-Pfad**: Stellen Sie sicher, dass Ihre virtuelle Umgebung unter „$SL5NET_AURA_PROJECT_ROOT/.venv“ eingerichtet ist. Wenn Sie Python mit „pyenv“ oder „conda“ verwalten, passen Sie „PY_EXEC“ entsprechend an.
