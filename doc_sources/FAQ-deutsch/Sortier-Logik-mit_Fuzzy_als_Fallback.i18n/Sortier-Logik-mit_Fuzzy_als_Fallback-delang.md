...
Die komplexen Fuzzy-Berechnungen werden nur als Fallback genutzt.
...
Wenn eine Regel **kein Full Match**, aber einen **partiellen Match** oder eine sonstige Ersetzung (ohne Stopp-Kriterium) ergibt:
...
### Phase 2: Der Fallback mit niedriger Priorität (Fuzzy).
...
2. **Regeln zur Kumulation (partieller Match):** Müssen in der logischen Reihenfolge der Transformationen stehen (vom Rohtext zur endgültigen Form). Sie setzen „current_rule_matched“ auf „True“ und **blockieren** damit den späteren Fuzzy-Fallbacks für diesen Token.
