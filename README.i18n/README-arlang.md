...
⚡ **~2.87 J** لكل اختبار (39 اختبارًا عبر أكثر من 800 خريطة عند 0.09 ثانية دافئة / 0.45 ثانية باردة 🌿 تم قياسها باستخدام [Eco-CI](https://metrics.green-coding.io/index.html)) · لا يوجد حساب سحابي
