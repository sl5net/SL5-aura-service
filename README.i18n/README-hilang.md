...
* **लिनक्स (मंजारो):** नया/प्रयोगात्मक: एक सिस्टम-वाइड हॉटकी एक fzf-जैसा, कीबोर्ड-संचालित इंटरफ़ेस खोलता है ताकि आप डेस्कटॉप पर कहीं से भी ऑरा कमांड चला सकें (सक्रिय विंडो से पूरी तरह से अलग)। यह हॉटकी-चालित लॉन्चर वर्तमान में लिनक्स (मंजारो) पर कार्यान्वित और परीक्षण किया गया है; अन्य वितरण काम कर सकते हैं लेकिन सेटअप की आवश्यकता है। 👉 [docs/Feature_Spotlight/CopyQ_Shortcut_Super_s.md](../docs/Feature_Spotlight/CopyQ_Shortcut_Super_s-hilang.md)    में देखें
