...
* **विंडोज़:** ✅ पूरी तरह से समर्थित (ऑटोहॉटकी/पॉवरशेल का उपयोग करता है)।
...
प्रोसेसिंग इंजन **पदानुक्रमित प्राथमिकता श्रृंखला** का सख्ती से पालन करता है:
...
││ * **डायनामिक स्क्रिप्ट निष्पादन:** नियम एपीआई कॉल, फ़ाइल I/O जैसी उन्नत क्रियाएं करने या गतिशील प्रतिक्रियाएं उत्पन्न करने के लिए कस्टम पायथन स्क्रिप्ट ([on_match_exec](../docs/advanced-scripting.i18n/advanced-scripting-hilang.md)) को ट्रिगर कर सकते हैं।  
