...
FUZZY_MAP_pre = [
    ...
    ('c', r'^\s*(llamar|controlar)\s*$', 85, # min_accuracy
 ...
 {'command_flags': re.IGNORECASE}),
    ...
    ('f', r'^\s*(doblar)\s*$', 85, # min_accuracy
 {'command_flags': re.IGNORECASE}),
    # EXAMPLE: descartar m

    ('d', r'^\s*(desechar)\s*$', 85, # min_accuracy
 {'command_flags': re.IGNORECASE}),
    # EXAMPLE: apuesta f

    ('b', r'^\s*(apuesta)\s*$', 85, # min_accuracy
 {'command_flags': re.IGNORECASE}),
    # EXAMPLE: intercambio m

    ('x', r'^\s*(intercambio)\s*$', 85, # min_accuracy
 {'command_flags': re.IGNORECASE}),
    # Teclas de cantidad

    # EXAMPLE: 100

    ('1', r'^\s*(100|uno centenar)\s*$', 85, # min_accuracy
 {'command_flags': re.IGNORECASE}),
    # EXAMPLE: 280

    ('2', r'^\s*(280|dos cincuenta)\s*$', 85, # min_accuracy
 {'command_flags': re.IGNORECASE}),
    # EXAMPLE: 80

    ('3', r'^\s*(80|cincuenta)\s*$', 85, # min_accuracy
 {'command_flags': re.IGNORECASE}),
