...
FUZZY_MAP_pre = [
    ...
    # EXAMPLE: nach süden
    ('kp2', fr'^\s*{nach}(s\w*|unten|runter)\s*$', 20, {'command_flags': re.IGNORECASE, 'only_in_windows': ['0ad', '0AD', '0 a.d.', '0 a.d'], 'on_match_exec': [CONFIG_DIR / '..' / '..' / '0ad_actions.py'], 'execute_only': True}),
