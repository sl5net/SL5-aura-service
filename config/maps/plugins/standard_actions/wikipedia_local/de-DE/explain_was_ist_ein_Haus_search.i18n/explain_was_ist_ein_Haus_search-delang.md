...
Dieses Setup ist eine elegante Möglichkeit, mehrdeutige oder generische Abfragen zu bearbeiten. Indem die spezifische Regel die Eingabe ändert oder eine gezielte Bezeichnung generiert und dann den Prozess dazu zwingt, mit der allgemeinen Suchregel fortzufahren, stellen Sie sicher, dass die Wikipedia-Suche nicht nach dem generischen „haus“, sondern nach dem spezifischen, eindeutigen Eintrag ausgeführt wird: **`haus (Begriffsklärung)`**.
