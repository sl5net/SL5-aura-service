...
FUZZY_MAP_pre = [
    ...
    ('Ferdinand-Lassalle-Straße 17-19, 72770 Reutlingen', r'^(Copy-Store|Copy shop).*Betzingen\s*$', 70, # min_accuracy
 {'command_flags': re.IGNORECASE}),

    # EXAMPLE: Copyshop Betzingen industrial area

    # EXAMPLE: Betzingen copy shop

    ('Ferdinand-Lassalle-Straße 17-19, 72770 Reutlingen', r'^(Betzingen).*(Copy-Store|Copy shop)\s*$', 70, # min_accuracy
 {'command_flags': re.IGNORECASE}),
    ...
    ('https://www.openstreetmap.org/#map=18/48.491606/9.156450', r'^(Betzingen).*(Copy-Store|Copy shop)\s*$', 70, # min_accuracy
 {'command_flags': re.IGNORECASE}),
