...
FUZZY_MAP_pre = [
    ...
    # Atelier de photocopie



    # site Web bitsundso bus982

    # EXAMPLE: Atelier de photocopie

    ('Ferdinand-Lassalle-Straße 17-19, 72770 Reutlingen', r'^(Copie-Magasin|Atelier de photocopie).*Betzingen\s*$', 70, # min_accuracy
 {'command_flags': re.IGNORECASE}),

    # EXEMPLE : Copyshop zone industrielle de Betzingen

    # EXAMPLE: Photocopieuse de Betzingen

    ('Ferdinand-Lassalle-Straße 17-19, 72770 Reutlingen', r'^(Betzingen).*(Copie-Magasin|Atelier de photocopie)\s*$', 70, # min_accuracy
 {'command_flags': re.IGNORECASE}),
    ...
    ('https://www.openstreetmap.org/#map=18/48.491606/9.156450', r'^(Betzingen).*(Copie-Magasin|Atelier de photocopie)\s*$', 70, # min_accuracy
 {'command_flags': re.IGNORECASE}),
