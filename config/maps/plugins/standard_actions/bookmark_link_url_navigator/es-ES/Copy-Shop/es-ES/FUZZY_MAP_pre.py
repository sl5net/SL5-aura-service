...
FUZZY_MAP_pre = [
    ...
    ('Ferdinand-Lassalle-Straße 17-19, 72770 Reutlingen', r'^(Copiar-Almacenar|copistería).*Betzingen\s*$', 70, # min_accuracy
 {'command_flags': re.IGNORECASE}),

    # EJEMPLO: Copistería en la zona industrial de Betzingen

    # EXAMPLE: Copistería Betzingen

    ('Ferdinand-Lassalle-Straße 17-19, 72770 Reutlingen', r'^(Betzingen).*(Copiar-Almacenar|copistería)\s*$', 70, # min_accuracy
 {'command_flags': re.IGNORECASE}),
    ...
    ('https://www.openstreetmap.org/#map=18/48.491606/9.156450', r'^(Betzingen).*(Copiar-Almacenar|copistería)\s*$', 70, # min_accuracy
 {'command_flags': re.IGNORECASE}),
