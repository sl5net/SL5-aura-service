...
def execute(match_data):
    ...
    try:
        ...
        # print(f"DEBUG traducir_de_a: INTERFAZ={INTERFACE}")
        ...
        # print(f"DEBUG traducir_de_a: lang_target={lang_target}")

        if lang_target is None:
            return original_text
    except Exception as e:
        # print(f"DEBUG traducir_de_a: EXCEPCIÓN={e}")

        # Alternativa: Translation_state.py si no se puede acceder a Trino
