...
Algunas acciones en el complemento del navegador de rutas dependen de utilidades de línea de comandos externas para realizar búsquedas aproximadas, enumerar archivos y manipular el portapapeles. Si faltan estas herramientas, verá una advertencia en la consola del sistema.
