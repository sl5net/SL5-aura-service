...
تعتمد بعض الإجراءات في البرنامج المساعد Path Navigator على أدوات مساعدة خارجية لسطر الأوامر لإجراء عمليات بحث غامضة، وقائمة الملفات، ومعالجة الحافظة. إذا كانت هذه الأدوات مفقودة، فسوف ترى تحذيرًا في وحدة تحكم النظام.
