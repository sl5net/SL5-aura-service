...
# config/maps/plugins/standard_actions/path_navigator/de-DE/FUZZY_MAP.py
...
# - banderas: use {'flags': re.IGNORECASE} para no distinguir entre mayúsculas y minúsculas, o 0 para distinguir entre mayúsculas y minúsculas.
