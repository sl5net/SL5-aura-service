...
*Este archivo explica la solución para la restricción de Aura sobre los caracteres especiales iniciales, documentando tanto la sustitución `tilde/` como el widget de integración Zsh.*
