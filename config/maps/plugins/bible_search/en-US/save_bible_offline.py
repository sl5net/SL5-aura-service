...
# --- Canonical LUTHER66 book order (correctable/flexible) ---
...
BIBLE_STRUCTURE = [
    ...
    # Add ALL other books (Jos, Ri, Rt, 1Sam, ... , Revb) --> See next comment for the full structure, or use an importable structure.
