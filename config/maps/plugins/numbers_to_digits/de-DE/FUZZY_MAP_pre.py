...
#  eins2025-1005-1324 eins
    ...
    ('8', r'(\b|\d)(acht)(\b|\d)', 87, re.IGNORECASE),
    ('9', r'(\b|\d)(neun)(\b|\d)', 87, re.IGNORECASE),
    ('10', r'(\b|\d)(zehn)(\b|\d)', 87, re.IGNORECASE),
    ('11', r'(\b|\d)(elf)(\b|\d)', 87, re.IGNORECASE),
    ('12', r'(\b|\d)(zwölf)(\b|\d)', 87, re.IGNORECASE),
    ('13', r'(\b|\d)(dreizehn)(\b|\d)', 87, re.IGNORECASE),
    ('14', r'(\b|\d)(vierzehn)(\b|\d)', 87, re.IGNORECASE),
    ('15', r'(\b|\d)(fünfzehn)(\b|\d)', 87, re.IGNORECASE),
    ('16', r'(\b|\d)(sechzehn)(\b|\d)', 87, re.IGNORECASE),
    ('17', r'(\b|\d)(siebzehn)(\b|\d)', 87, re.IGNORECASE),
    ('18', r'(\b|\d)(achtzehn)(\b|\d)', 87, re.IGNORECASE),
    ('19', r'(\b|\d)(neunzehn)(\b|\d)', 87, re.IGNORECASE),
    ('20', r'(\b|\d)(zwanzig)(\b|\d)', 87, re.IGNORECASE),
    ('30', r'(\b|\d)(dreißig)(\b|\d)', 87, re.IGNORECASE),
    ('40', r'(\b|\d)(vierzig)(\b|\d)', 87, re.IGNORECASE),
    ('50', r'(\b|\d)(fünfzig)(\b|\d)', 87, re.IGNORECASE),
    ('60', r'(\b|\d)(sechzig)(\b|\d)', 87, re.IGNORECASE),
    ('70', r'(\b|\d)(siebzig)(\b|\d)', 87, re.IGNORECASE),
    ('80', r'(\b|\d)(achtzig)(\b|\d)', 87, re.IGNORECASE),
