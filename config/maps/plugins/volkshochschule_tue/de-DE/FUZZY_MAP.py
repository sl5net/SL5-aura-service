...
FUZZY_MAP = [
    ...
    ('Fachbereichsleitung', r'\bFach\w*\s+Bereichsleitung\b', 70, {'command_flags': re.IGNORECASE}) ,

    # EXAMPLE: PBW textix tx ex Buch
    ('Python-Buch', r'\b([PBW]\w+i\w*t\w*e\w* Buch)\b', 60, {'command_flags': re.IGNORECASE}),


    # EXAMPLE: Kursleiter Schulung
    ('Kursleiterschulung', r'\b(Kursleiter\s*schu\w*)\b', 60, {'command_flags': re.IGNORECASE})
