...
def execute(match_data):
    ...
    # file_filter = "*.md"
        ...
        # salir(1)Fuera a los motoresAbuelo atrásSufijos de era

    #
    # Los estúpidos documentos de Jura. Hurra, espero que vengas. Dora, espero que vengas.

    # idioma_actual = Ruta(__archivo__).padre.nombre.split("-")[0]
