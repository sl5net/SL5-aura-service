...
def execute(match_data):
    # TMP_DIR = Ruta("C:/tmp") si plataforma.system() == "Windows" en caso contrario Ruta("/tmp")
    ...
    # Desacople la sesión de inicio para que la ventana permanezca independiente de Aura
