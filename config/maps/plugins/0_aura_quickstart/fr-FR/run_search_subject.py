...
def execute(match_data):
    ...
    # Collection : consécration

    docs_dir = None
    print('_________________________')
    print(f'dirpath_spoken: {dirpath_spoken}')
    assign_re = re.compile(r'^(?:Configuration\w*|configuration\w*|configuration|consécration)$', re.IGNORECASE)
    ...
    if docs_dir == 'config':
        ...
        file_filter = "*.py"
# Confédération rougeAura timide ConfigurationsConfiguration de recherche DoraSur de si bonnes vibrationsConfiguration de recherche O
