...
# Même logique ici pour garantir que les utils sont trouvés lorsqu'ils sont appelés depuis simulation_conversation
...
def check_db_statistics_and_exit_if_invalid():
    ...
    try:
        ...
        # Interroger correctement le nombre total d'accès
        ...
        # Interroger correctement les invites uniques
        ...
        # Sortie d'erreur en cas de panne
