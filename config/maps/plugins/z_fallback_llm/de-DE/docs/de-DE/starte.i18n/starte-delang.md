...
aus config.maps.plugins.standard_actions.get_suggestions get_suggestions importieren
...
Wenn Sie den korrigierten Befehl verwenden, sollte die ursprüngliche Fehlermeldung (`No module name 'config.maps'`) behoben sein, da Python nun das Root-Verzeichnis Ihres Projekts korrekt in den Suchpfad aufnimmt.