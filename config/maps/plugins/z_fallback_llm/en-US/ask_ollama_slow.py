...
def execute(match_data):
    ...
    try:
        ...
        AURA_TECH_PROFILE = (  # noqa: F841
            ...
            # --- RegEx processing (top-down & stop logic) ---
        ...
        # --- Mode initialization (set FIXED to NORMAL) ---
        ...
        try:
            ...
            if not bypass_cache:
                ...
                # IMPORTANT: We use the same hash_input_string here (based on keywords),

                # which we used for reading above!
