...
'only_in_windows': ['Konsole', 'konsole', 'Console',
 ...
 {'command_flags': re.IGNORECASE}),
   ...
   {'command_flags': re.IGNORECASE, 'only_in_windows': ['Konsole', 'konsole', 'Terminal', 'Console', 'gnome-terminal', 'xterm', 'tilix', 'terminator', 'iTerm2', 'iTerm', 'Alacritty', 'kitty', 'Warp', 'Ghostty']}),
    ...
    ('!git add . && git commit -m "WIP" && git push; && git ', r'^\s*(git|va[^\s]*|aller|grille|Gitta|Kate|Kathé|chaton|décret|avec)\s*(rapide|rapide|sale|essuyer)?\s*$', 82,      {'command_flags': re.IGNORECASE, 'only_in_windows': ['Konsole', 'konsole', 'Terminal', 'Console', 'gnome-terminal', 'xterm', 'tilix', 'terminator', 'iTerm2', 'iTerm', 'Alacritty', 'kitty', 'Warp', 'Ghostty']}),
    ############################################
    ...
    ('git diff ', r'^\s*(trousse|git|va|pêche)\s*(diff|profond|tiff|tuv|jus|conseils|va\'s|kittys|dies|die)\s*$', 75,      {'command_flags': re.IGNORECASE, 'only_in_windows': ['Konsole', 'konsole', 'Terminal', 'Console', 'gnome-terminal', 'xterm', 'tilix', 'terminator', 'iTerm2', 'iTerm', 'Alacritty', 'kitty', 'Warp', 'Ghostty']}),
