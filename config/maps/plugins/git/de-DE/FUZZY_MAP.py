...
#    ('drei', r'zwei', 60, re.IGNORECASE),
 ...
 #  zweis drei
    ...
    ('git status', r'^\s*(git|geht|gitter|kids)\s+(status|staates|statt|stade|dates)\s*$', 82, re.IGNORECASE),
    ...
    ('git commit ', r'^\s*Geht (Komet|kommend|korrekt|Commit)\s*$', 80, re.IGNORECASE),
