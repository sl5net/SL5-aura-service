...
'only_in_windows': ['Konsole', 'konsole', 'Console',
    ...
    ('please short Raw Commit-Message(no CLI) for uncommitted changes in English. Keep subjects under ~50 characters when possible. Use imperative mood (e.g., "Add", "Fix", "Respect").', rf'\b{gitGit}\b\s*\b{commitGit} text in english\b', 80, {'command_flags': re.IGNORECASE}),
