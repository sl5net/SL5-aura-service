...
# La liste est enregistrée dans un simple fichier texte dans le même dossier
...
def execute(match_data):
    ...
    # Commande : Ajouter quelque chose
...
# Les chaussures sur la liste de courses Les voitures sont sur la liste de courses
