...
- **Sicherheits-Check**: Warnung aktiv, wenn das PDF-Jahr abgelaufen ist oder die Datei fehlt.
...
3. Der Dienst erkennt das neue Jahr automatisch am Dateinamen.
4. Wenn das PDF fehlt oder veraltet ist, sendet das System täglich eine Fehlermeldung.
