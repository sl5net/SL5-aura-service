...
# config/maps/koans_2_peter_deutsch/05_koan_such_example/de-DE/FUZZY_MAP_pre.py
...
# PETER TASK for Koan: 05_koan_such_example

# There is ONE commented out rule.

# -> Remove the '#' to activate it.

# -> What happens in the pipeline afterwards?
