...
# PETER TAREA para Koan: 01_koan_first_steps

# Hay UNA regla comentada.

# -> Elimina el '#' para activarlo.

# -> ¿Qué sucede después en el proceso?

FUZZY_MAP_pre = [

    # TODO: Sólo una tarea:

    # Elimine el '#' antes de la regla siguiente.

    # ¿Lo que sucede? ¿Por qué se detiene el oleoducto después de esto?

    # ('hola 01_koan_first_steps', r'^.*$'),
