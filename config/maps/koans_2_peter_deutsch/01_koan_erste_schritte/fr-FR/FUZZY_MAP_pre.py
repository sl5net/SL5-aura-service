...
# TÂCHE DE PETER pour Koan : 01_koan_first_steps

# Il y a UNE règle commentée.

# -> Supprimez le '#' pour l'activer.

# -> Que se passe-t-il ensuite dans le pipeline ?

FUZZY_MAP_pre = [

    # À FAIRE : Une seule tâche :

    # Supprimez le « # » avant la règle ci-dessous.

    # Ce qui se produit? Pourquoi le pipeline s’arrête-t-il après cela ?

    # ('salut 01_koan_first_steps', r'^.*$'),
