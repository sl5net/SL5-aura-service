...
def create_scratchpad_layout(root: tk.Tk) -> Tuple[tk.Text, tk.Frame]:
    """
    Configures and packs standard UI widgets for the AURA Scratchpad.
    Returns (text_area, suggestions_panel).
    """
    ...
    panel_frame.pack(fill="x", padx=8, pady=4)
